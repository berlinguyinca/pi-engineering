# BAR-080 — Repair engine: Define scope and inputs

## Goal
Generate and execute bounded repair campaigns with regression and reconciliation. This atomic step focuses on: define scope and inputs.
