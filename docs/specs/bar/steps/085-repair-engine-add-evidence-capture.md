# BAR-085 — Repair engine: Add evidence capture

## Goal
Generate and execute bounded repair campaigns with regression and reconciliation. This atomic step focuses on: add evidence capture.
