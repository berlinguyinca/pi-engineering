# BAR-129 — Hardening: Verify phase exit gate

## Goal
Make brownfield activation automatic, resumable, reportable and production-ready. This atomic step focuses on: verify phase exit gate.
...
Demonstrate end-to-end that the Hardening phase accomplishes: Make brownfield activation automatic, resumable, reportable and production-ready. Run a deliberate defect/failure proving the phase catches incorrect behavior, then restore/fix it and prove recovery. Freeze the phase evidence before proceeding.
