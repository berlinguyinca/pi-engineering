# BAR-056 — CAV baseline: Add reconciliation logic

## Goal
Map/generate acceptance evidence, execute CAV and freeze immutable baseline. This atomic step focuses on: add reconciliation logic.
