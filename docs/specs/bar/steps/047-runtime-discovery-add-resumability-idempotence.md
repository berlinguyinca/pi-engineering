# BAR-047 — Runtime discovery: Add resumability/idempotence

## Goal
Launch real stack and map observable services, routes, APIs, streams and topology. This atomic step focuses on: add resumability/idempotence.
