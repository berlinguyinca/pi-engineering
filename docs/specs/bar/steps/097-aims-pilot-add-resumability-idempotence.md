# BAR-097 — AIMS pilot: Add resumability/idempotence

## Goal
Apply BAR to AIMS with console/runtime-specific profile. This atomic step focuses on: add resumability/idempotence.
