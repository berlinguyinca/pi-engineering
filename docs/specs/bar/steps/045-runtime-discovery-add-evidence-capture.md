# BAR-045 — Runtime discovery: Add evidence capture

## Goal
Launch real stack and map observable services, routes, APIs, streams and topology. This atomic step focuses on: add evidence capture.
