# BAR-044 — Runtime discovery: Add negative/adversarial cases

## Goal
Launch real stack and map observable services, routes, APIs, streams and topology. This atomic step focuses on: add negative/adversarial cases.
