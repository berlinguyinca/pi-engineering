# BAR-120 — Hardening: Define scope and inputs

## Goal
Make brownfield activation automatic, resumable, reportable and production-ready. This atomic step focuses on: define scope and inputs.
