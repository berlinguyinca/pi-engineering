# BAR-094 — AIMS pilot: Add negative/adversarial cases

## Goal
Apply BAR to AIMS with console/runtime-specific profile. This atomic step focuses on: add negative/adversarial cases.
