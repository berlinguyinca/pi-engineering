# BAR-078 — Root-cause analysis: Dogfood and repair

## Goal
Cluster findings, construct dependency graph and prioritize foundational causes. This atomic step focuses on: dogfood and repair.
