# BAR-038 — Source reconciliation: Dogfood and repair

## Goal
Map requirements to implementation and identify missing/orphan/legacy code. This atomic step focuses on: dogfood and repair.
