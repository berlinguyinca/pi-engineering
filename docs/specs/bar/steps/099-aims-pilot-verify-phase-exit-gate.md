# BAR-099 — AIMS pilot: Verify phase exit gate

## Goal
Apply BAR to AIMS with console/runtime-specific profile. This atomic step focuses on: verify phase exit gate.
...
Demonstrate end-to-end that the AIMS pilot phase accomplishes: Apply BAR to AIMS with console/runtime-specific profile. Run a deliberate defect/failure proving the phase catches incorrect behavior, then restore/fix it and prove recovery. Freeze the phase evidence before proceeding.
