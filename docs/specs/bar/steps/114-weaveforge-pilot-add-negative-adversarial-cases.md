# BAR-114 — WeaveForge pilot: Add negative/adversarial cases

## Goal
Apply BAR to WeaveForge with orchestration/adversarial profile. This atomic step focuses on: add negative/adversarial cases.
