# BAR-121 — Hardening: Implement persistent data model

## Goal
Make brownfield activation automatic, resumable, reportable and production-ready. This atomic step focuses on: implement persistent data model.
