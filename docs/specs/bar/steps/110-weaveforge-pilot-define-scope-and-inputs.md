# BAR-110 — WeaveForge pilot: Define scope and inputs

## Goal
Apply BAR to WeaveForge with orchestration/adversarial profile. This atomic step focuses on: define scope and inputs.
