# BAR-048 — Runtime discovery: Dogfood and repair

## Goal
Launch real stack and map observable services, routes, APIs, streams and topology. This atomic step focuses on: dogfood and repair.
