# BAR-064 — Deep QA: Add negative/adversarial cases

## Goal
Run visual, exploratory, responsive, error-path, soak and state-consistency audits. This atomic step focuses on: add negative/adversarial cases.
