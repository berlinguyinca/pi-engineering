# BAR-102 — InferWeave pilot: Implement discovery/collection

## Goal
Apply BAR to InferWeave with distributed-system/failure-injection profile. This atomic step focuses on: implement discovery/collection.
