# BAR-087 — Repair engine: Add resumability/idempotence

## Goal
Generate and execute bounded repair campaigns with regression and reconciliation. This atomic step focuses on: add resumability/idempotence.
