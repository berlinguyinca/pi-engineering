# BAR-072 — Root-cause analysis: Implement discovery/collection

## Goal
Cluster findings, construct dependency graph and prioritize foundational causes. This atomic step focuses on: implement discovery/collection.
