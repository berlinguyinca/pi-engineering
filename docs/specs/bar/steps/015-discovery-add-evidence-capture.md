# BAR-015 — Discovery: Add evidence capture

## Goal
Discover repository structure, specs, ADRs, designs, tests, configs and historical claims. This atomic step focuses on: add evidence capture.
