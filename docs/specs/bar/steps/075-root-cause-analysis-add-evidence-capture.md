# BAR-075 — Root-cause analysis: Add evidence capture

## Goal
Cluster findings, construct dependency graph and prioritize foundational causes. This atomic step focuses on: add evidence capture.
