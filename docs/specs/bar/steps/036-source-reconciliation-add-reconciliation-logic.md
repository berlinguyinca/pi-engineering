# BAR-036 — Source reconciliation: Add reconciliation logic

## Goal
Map requirements to implementation and identify missing/orphan/legacy code. This atomic step focuses on: add reconciliation logic.
