# BAR-060 — Deep QA: Define scope and inputs

## Goal
Run visual, exploratory, responsive, error-path, soak and state-consistency audits. This atomic step focuses on: define scope and inputs.
