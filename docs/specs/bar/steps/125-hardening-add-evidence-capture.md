# BAR-125 — Hardening: Add evidence capture

## Goal
Make brownfield activation automatic, resumable, reportable and production-ready. This atomic step focuses on: add evidence capture.
