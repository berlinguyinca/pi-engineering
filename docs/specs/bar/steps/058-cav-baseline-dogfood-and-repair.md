# BAR-058 — CAV baseline: Dogfood and repair

## Goal
Map/generate acceptance evidence, execute CAV and freeze immutable baseline. This atomic step focuses on: dogfood and repair.
