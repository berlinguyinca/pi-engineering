# BAR-092 — AIMS pilot: Implement discovery/collection

## Goal
Apply BAR to AIMS with console/runtime-specific profile. This atomic step focuses on: implement discovery/collection.
