# BAR-002 — Bootstrap & dogfood: Implement discovery/collection

## Goal
Audit current Pi Engineering/CAV itself and establish BAR root of trust. This atomic step focuses on: implement discovery/collection.
