# BAR-122 — Hardening: Implement discovery/collection

## Goal
Make brownfield activation automatic, resumable, reportable and production-ready. This atomic step focuses on: implement discovery/collection.
