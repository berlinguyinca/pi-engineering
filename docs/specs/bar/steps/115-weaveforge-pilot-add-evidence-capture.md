# BAR-115 — WeaveForge pilot: Add evidence capture

## Goal
Apply BAR to WeaveForge with orchestration/adversarial profile. This atomic step focuses on: add evidence capture.
