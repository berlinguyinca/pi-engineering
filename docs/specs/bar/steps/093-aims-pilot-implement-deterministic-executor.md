# BAR-093 — AIMS pilot: Implement deterministic executor

## Goal
Apply BAR to AIMS with console/runtime-specific profile. This atomic step focuses on: implement deterministic executor.
