# BAR-042 — Runtime discovery: Implement discovery/collection

## Goal
Launch real stack and map observable services, routes, APIs, streams and topology. This atomic step focuses on: implement discovery/collection.
