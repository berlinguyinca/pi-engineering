# BAR-005 — Bootstrap & dogfood: Add evidence capture

## Goal
Audit current Pi Engineering/CAV itself and establish BAR root of trust. This atomic step focuses on: add evidence capture.
