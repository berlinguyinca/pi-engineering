# BAR-057 — CAV baseline: Add resumability/idempotence

## Goal
Map/generate acceptance evidence, execute CAV and freeze immutable baseline. This atomic step focuses on: add resumability/idempotence.
