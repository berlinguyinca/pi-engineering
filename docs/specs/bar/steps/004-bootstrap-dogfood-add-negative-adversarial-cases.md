# BAR-004 — Bootstrap & dogfood: Add negative/adversarial cases

## Goal
Audit current Pi Engineering/CAV itself and establish BAR root of trust. This atomic step focuses on: add negative/adversarial cases.
