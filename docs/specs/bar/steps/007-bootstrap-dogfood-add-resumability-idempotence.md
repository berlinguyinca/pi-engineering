# BAR-007 — Bootstrap & dogfood: Add resumability/idempotence

## Goal
Audit current Pi Engineering/CAV itself and establish BAR root of trust. This atomic step focuses on: add resumability/idempotence.
