# BAR-052 — CAV baseline: Implement discovery/collection

## Goal
Map/generate acceptance evidence, execute CAV and freeze immutable baseline. This atomic step focuses on: implement discovery/collection.
