# BAR-074 — Root-cause analysis: Add negative/adversarial cases

## Goal
Cluster findings, construct dependency graph and prioritize foundational causes. This atomic step focuses on: add negative/adversarial cases.
