# BAR-030 — Source reconciliation: Define scope and inputs

## Goal
Map requirements to implementation and identify missing/orphan/legacy code. This atomic step focuses on: define scope and inputs.
