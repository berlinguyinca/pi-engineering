# BAR-024 — Requirement reconstruction: Add negative/adversarial cases

## Goal
Atomize requirements with provenance and initialize UNKNOWN truth state. This atomic step focuses on: add negative/adversarial cases.
