# BAR-101 — InferWeave pilot: Implement persistent data model

## Goal
Apply BAR to InferWeave with distributed-system/failure-injection profile. This atomic step focuses on: implement persistent data model.
