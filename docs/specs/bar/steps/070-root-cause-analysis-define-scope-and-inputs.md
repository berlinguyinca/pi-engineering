# BAR-070 — Root-cause analysis: Define scope and inputs

## Goal
Cluster findings, construct dependency graph and prioritize foundational causes. This atomic step focuses on: define scope and inputs.
