# BAR-071 — Root-cause analysis: Implement persistent data model

## Goal
Cluster findings, construct dependency graph and prioritize foundational causes. This atomic step focuses on: implement persistent data model.
