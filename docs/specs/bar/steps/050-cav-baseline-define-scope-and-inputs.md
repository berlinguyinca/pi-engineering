# BAR-050 — CAV baseline: Define scope and inputs

## Goal
Map/generate acceptance evidence, execute CAV and freeze immutable baseline. This atomic step focuses on: define scope and inputs.
