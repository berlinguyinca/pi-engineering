# BAR-076 — Root-cause analysis: Add reconciliation logic

## Goal
Cluster findings, construct dependency graph and prioritize foundational causes. This atomic step focuses on: add reconciliation logic.
