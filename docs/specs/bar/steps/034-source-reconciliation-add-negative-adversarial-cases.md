# BAR-034 — Source reconciliation: Add negative/adversarial cases

## Goal
Map requirements to implementation and identify missing/orphan/legacy code. This atomic step focuses on: add negative/adversarial cases.
