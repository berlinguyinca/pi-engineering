# BAR-127 — Hardening: Add resumability/idempotence

## Goal
Make brownfield activation automatic, resumable, reportable and production-ready. This atomic step focuses on: add resumability/idempotence.
