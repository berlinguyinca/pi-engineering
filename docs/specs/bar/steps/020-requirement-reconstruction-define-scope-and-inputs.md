# BAR-020 — Requirement reconstruction: Define scope and inputs

## Goal
Atomize requirements with provenance and initialize UNKNOWN truth state. This atomic step focuses on: define scope and inputs.
