# BAR-100 — InferWeave pilot: Define scope and inputs

## Goal
Apply BAR to InferWeave with distributed-system/failure-injection profile. This atomic step focuses on: define scope and inputs.
