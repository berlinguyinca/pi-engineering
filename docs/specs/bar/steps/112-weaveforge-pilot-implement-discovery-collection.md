# BAR-112 — WeaveForge pilot: Implement discovery/collection

## Goal
Apply BAR to WeaveForge with orchestration/adversarial profile. This atomic step focuses on: implement discovery/collection.
