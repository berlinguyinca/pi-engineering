# BAR-067 — Deep QA: Add resumability/idempotence

## Goal
Run visual, exploratory, responsive, error-path, soak and state-consistency audits. This atomic step focuses on: add resumability/idempotence.
