# BAR-109 — InferWeave pilot: Verify phase exit gate

## Goal
Apply BAR to InferWeave with distributed-system/failure-injection profile. This atomic step focuses on: verify phase exit gate.
...
Demonstrate end-to-end that the InferWeave pilot phase accomplishes: Apply BAR to InferWeave with distributed-system/failure-injection profile. Run a deliberate defect/failure proving the phase catches incorrect behavior, then restore/fix it and prove recovery. Freeze the phase evidence before proceeding.
