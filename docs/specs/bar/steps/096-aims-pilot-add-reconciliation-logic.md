# BAR-096 — AIMS pilot: Add reconciliation logic

## Goal
Apply BAR to AIMS with console/runtime-specific profile. This atomic step focuses on: add reconciliation logic.
