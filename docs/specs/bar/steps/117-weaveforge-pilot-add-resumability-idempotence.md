# BAR-117 — WeaveForge pilot: Add resumability/idempotence

## Goal
Apply BAR to WeaveForge with orchestration/adversarial profile. This atomic step focuses on: add resumability/idempotence.
