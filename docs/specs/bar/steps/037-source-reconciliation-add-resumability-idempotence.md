# BAR-037 — Source reconciliation: Add resumability/idempotence

## Goal
Map requirements to implementation and identify missing/orphan/legacy code. This atomic step focuses on: add resumability/idempotence.
