# BAR-010 — Discovery: Define scope and inputs

## Goal
Discover repository structure, specs, ADRs, designs, tests, configs and historical claims. This atomic step focuses on: define scope and inputs.
