# BAR-126 — Hardening: Add reconciliation logic

## Goal
Make brownfield activation automatic, resumable, reportable and production-ready. This atomic step focuses on: add reconciliation logic.
