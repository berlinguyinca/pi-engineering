# BAR-040 — Runtime discovery: Define scope and inputs

## Goal
Launch real stack and map observable services, routes, APIs, streams and topology. This atomic step focuses on: define scope and inputs.
