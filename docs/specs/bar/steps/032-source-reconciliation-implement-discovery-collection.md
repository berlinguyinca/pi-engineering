# BAR-032 — Source reconciliation: Implement discovery/collection

## Goal
Map requirements to implementation and identify missing/orphan/legacy code. This atomic step focuses on: implement discovery/collection.
