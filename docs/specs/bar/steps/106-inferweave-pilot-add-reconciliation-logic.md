# BAR-106 — InferWeave pilot: Add reconciliation logic

## Goal
Apply BAR to InferWeave with distributed-system/failure-injection profile. This atomic step focuses on: add reconciliation logic.
