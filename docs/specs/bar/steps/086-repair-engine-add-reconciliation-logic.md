# BAR-086 — Repair engine: Add reconciliation logic

## Goal
Generate and execute bounded repair campaigns with regression and reconciliation. This atomic step focuses on: add reconciliation logic.
