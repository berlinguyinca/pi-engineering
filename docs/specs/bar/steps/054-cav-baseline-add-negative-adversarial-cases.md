# BAR-054 — CAV baseline: Add negative/adversarial cases

## Goal
Map/generate acceptance evidence, execute CAV and freeze immutable baseline. This atomic step focuses on: add negative/adversarial cases.
