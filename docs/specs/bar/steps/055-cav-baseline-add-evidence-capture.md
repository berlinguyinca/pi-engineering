# BAR-055 — CAV baseline: Add evidence capture

## Goal
Map/generate acceptance evidence, execute CAV and freeze immutable baseline. This atomic step focuses on: add evidence capture.
