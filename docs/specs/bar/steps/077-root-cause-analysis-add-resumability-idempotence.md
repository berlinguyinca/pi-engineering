# BAR-077 — Root-cause analysis: Add resumability/idempotence

## Goal
Cluster findings, construct dependency graph and prioritize foundational causes. This atomic step focuses on: add resumability/idempotence.
