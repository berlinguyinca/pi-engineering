# BAR-105 — InferWeave pilot: Add evidence capture

## Goal
Apply BAR to InferWeave with distributed-system/failure-injection profile. This atomic step focuses on: add evidence capture.
