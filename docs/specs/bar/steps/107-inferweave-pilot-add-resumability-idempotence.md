# BAR-107 — InferWeave pilot: Add resumability/idempotence

## Goal
Apply BAR to InferWeave with distributed-system/failure-injection profile. This atomic step focuses on: add resumability/idempotence.
