# BAR-062 — Deep QA: Implement discovery/collection

## Goal
Run visual, exploratory, responsive, error-path, soak and state-consistency audits. This atomic step focuses on: implement discovery/collection.
