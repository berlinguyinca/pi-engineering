# BAR-019 — Discovery: Verify phase exit gate

## Goal
Discover repository structure, specs, ADRs, designs, tests, configs and historical claims. This atomic step focuses on: verify phase exit gate.
...
Demonstrate end-to-end that the Discovery phase accomplishes: Discover repository structure, specs, ADRs, designs, tests, configs and historical claims. Run a deliberate defect/failure proving the phase catches incorrect behavior, then restore/fix it and prove recovery. Freeze the phase evidence before proceeding.
