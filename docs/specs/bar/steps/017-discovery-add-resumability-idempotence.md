# BAR-017 — Discovery: Add resumability/idempotence

## Goal
Discover repository structure, specs, ADRs, designs, tests, configs and historical claims. This atomic step focuses on: add resumability/idempotence.
