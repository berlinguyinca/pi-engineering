# BAR-104 — InferWeave pilot: Add negative/adversarial cases

## Goal
Apply BAR to InferWeave with distributed-system/failure-injection profile. This atomic step focuses on: add negative/adversarial cases.
