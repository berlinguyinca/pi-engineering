# BAR-035 — Source reconciliation: Add evidence capture

## Goal
Map requirements to implementation and identify missing/orphan/legacy code. This atomic step focuses on: add evidence capture.
