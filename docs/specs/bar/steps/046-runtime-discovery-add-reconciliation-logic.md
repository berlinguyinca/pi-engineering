# BAR-046 — Runtime discovery: Add reconciliation logic

## Goal
Launch real stack and map observable services, routes, APIs, streams and topology. This atomic step focuses on: add reconciliation logic.
