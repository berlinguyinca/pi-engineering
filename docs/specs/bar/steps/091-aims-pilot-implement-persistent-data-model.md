# BAR-091 — AIMS pilot: Implement persistent data model

## Goal
Apply BAR to AIMS with console/runtime-specific profile. This atomic step focuses on: implement persistent data model.
