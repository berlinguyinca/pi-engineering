# BAR-068 — Deep QA: Dogfood and repair

## Goal
Run visual, exploratory, responsive, error-path, soak and state-consistency audits. This atomic step focuses on: dogfood and repair.
