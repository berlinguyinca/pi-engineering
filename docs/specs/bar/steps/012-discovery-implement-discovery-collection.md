# BAR-012 — Discovery: Implement discovery/collection

## Goal
Discover repository structure, specs, ADRs, designs, tests, configs and historical claims. This atomic step focuses on: implement discovery/collection.
