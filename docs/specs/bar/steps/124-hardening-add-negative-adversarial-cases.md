# BAR-124 — Hardening: Add negative/adversarial cases

## Goal
Make brownfield activation automatic, resumable, reportable and production-ready. This atomic step focuses on: add negative/adversarial cases.
